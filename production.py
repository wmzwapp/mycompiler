...
class production:
    ...
    def __eq__(self,other):
        return self.__isitem==other.__isitem and self.__left==other.__left and self.__dot==other.__dot and self.__right==other.__right and self.__next==other.__next
